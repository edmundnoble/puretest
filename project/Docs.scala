...
object Docs {
  ...
  lazy val docSettings = Seq(
    ...
    git.remoteRepo := "git@github.com:edmundnoble/puretest.git",
    includeFilter in makeSite := "*.html" | "*.css" | "*.png" | "*.jpg" | "*.gif" | "*.js" | "*.swf" | "*.yml" | "*.md"
  )

  val doctestSettings: Seq[Setting[_]] = Def.settings(
